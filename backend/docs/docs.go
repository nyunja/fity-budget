                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.OnboardingRequest"
                        }
                    }
                ],
                "responses": {
                                        ...
                                        "data": {
                                            ...
                                            "properties": {
                                                "goals": {
                                                    "type": "array",
                                                    "items": {
                                                        "$ref": "#/definitions/models.SavingGoal"
                                                    }
                                                }
                                            }
                                        }
    ...
    "definitions": {
        ...
        "models.Wallet": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "Mobile Money, Bank, Cash, Credit, Savings",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
