...
import { useAnalyticsData, useFinancialMetrics, useHealthScore, useCategoryData, useRecurringExpenses } from '../hooks/useAnalytics';
...
const AnalyticsPage: React.FC = () => {
   ...
   const { healthScore, healthLabel } = useHealthScore(savingsRate, budgets, transactions);
   ...
   const recurringList = useRecurringExpenses(transactions);
