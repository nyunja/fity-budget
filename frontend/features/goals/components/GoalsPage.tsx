...
const GoalsPage: React.FC = () => {
  ...
  const {
    ...
    updating,
    deleting
  } = useGoalMutations({ onSuccess: refetch });
  ...
  // Metrics
  const { totalTarget, totalSaved, averageProgress, activeGoalsCount } = useGoalMetrics(goals);
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    const result = await createGoal(getFormData());
  ...
  const handleAddAmount = async (goalId: string, amount: number) => {
    const result = await updateProgress(goalId, amount);
    if (result.success) {
              ...
              <form onSubmit={handleCreateSubmit} className="space-y-5">
                 ...
                 <div>
                    ...
                    <input 
                      ...
                      required
                      value={formData.name}
                      onChange={(e) => setters.setFormName(e.target.value)}
                    ...
                    <div>
                      ...
                      <div className="relative">
                         ...
                         <input 
                           ...
                           onChange={(e) => setters.setFormTarget(e.target.value)}
                    ...
                    <div>
                      ...
                      <div className="relative">
                         ...
                         <input 
                           ...
                           onChange={(e) => setters.setFormCurrent(e.target.value)}
                           className="w-full pl-7 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-indigo-500 outline-none"
                           placeholder="0"
                         />
                      </div>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div>
                       ...
                       <input 
                         ...
                         onChange={(e) => setters.setFormDeadline(e.target.value)}
                    ...
                    <div>
                       ...
                       <select
                         ...
                         onChange={(e) => setters.setFormPriority(e.target.value as any)}
                 ...
                 <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setters.setFormCategory(e.target.value)}
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-indigo-500 outline-none appearance-none"
                    >
